...
export default function CallToAction() {
  return (
    <section class="bg-hotAir bg-cover bg-center font-Poppins">
    <div class="max-w-2xl mx-auto text-center py-12 px-4">
        ...
        Discover new places, meet new people, and create unforgettable memories.
        </p>

        <a href="#" class="min-w-[150px] max-w-[300px] mx-auto mt-8 text-md flex items-center justify-center
